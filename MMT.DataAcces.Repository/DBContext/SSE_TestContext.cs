...
namespace MMT.DataAcces.Repository
{
    public partial class SSE_TestContext : DbContext
    {
        private readonly string _connectionString;

        public SSE_TestContext(string connectionString)
        {
            _connectionString = connectionString;
        }

        public SSE_TestContext(DbContextOptions<SSE_TestContext> options, string connectionString)
            : base(options)
        {
            _connectionString = connectionString;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Orderitem>().HasKey(s => new { s.Product, s.Order });
